# =============================================================================
# gpu-optimus-no-busid — eval-only ft.gpu detection test machine
# =============================================================================
#
# Points ft.facter.reportPath at the hand-crafted hardware report
# fixtures/gpu/optimus-no-busid.json and expects ft.gpu autodetection to
# detect the NVIDIA vendor but leave PRIME and ft.cardwire off because the dGPU has no valid sysfs_bus_id.
...

{
  ...
  ft.facter.reportPath = ../../fixtures/gpu/optimus-no-busid.json;
  ft.gpu.enable = true;
