# =============================================================================
# gpu-fallback-unknown — eval-only ft.gpu detection test machine
# =============================================================================
#
# Points ft.facter.reportPath at the hand-crafted hardware report
# fixtures/gpu/fallback-unknown.json and expects ft.gpu autodetection to
# fall back to the default vendor (amd) for an unrecognised GPU.
...

{
  ...
  ft.facter.reportPath = ../../fixtures/gpu/fallback-unknown.json;
  ft.gpu.enable = true;
