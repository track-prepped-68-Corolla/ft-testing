# =============================================================================
# vendorHw-chassis-11 — eval-only ft.vendorHw detection test machine
# =============================================================================
#
# Points ft.facter.reportPath at the hand-crafted hardware report
# fixtures/vendorHw/chassis-11.json and expects ft.vendorHw autodetection to
# enable InputPlumber/PowerStation (SMBIOS chassis type 11 = Hand Held).
...

{
  ...
  ft.facter.reportPath = ../../fixtures/vendorHw/chassis-11.json;
