# =============================================================================
# vendorHw-no-match — eval-only ft.vendorHw detection test machine
# =============================================================================
#
# Points ft.facter.reportPath at the hand-crafted hardware report
# fixtures/vendorHw/no-match.json and expects ft.vendorHw autodetection to
# enable nothing (Dell desktop strings, no matching USB vendors).
...

{
  ...
  ft.facter.reportPath = ../../fixtures/vendorHw/no-match.json;
