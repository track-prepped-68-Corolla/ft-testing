# =============================================================================
# vendorHw-gpd-handheld — eval-only ft.vendorHw detection test machine
# =============================================================================
#
# Points ft.facter.reportPath at the hand-crafted hardware report
# fixtures/vendorHw/gpd-handheld.json and expects ft.vendorHw autodetection to
# enable InputPlumber/PowerStation (DMI manufacturer "GPD").
...

{
  ...
  ft.facter.reportPath = ../../fixtures/vendorHw/gpd-handheld.json;
